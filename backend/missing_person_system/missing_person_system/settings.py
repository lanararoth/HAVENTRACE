"""
Django settings for missing_person_system project.
...
SECRET_KEY = 'django-insecure-g0p@wsj8fswxnr+na__e2m@k@ee5k9*cftp$(%=)box8*o8nm0'
...
ROOT_URLCONF = 'missing_person_system.urls'
...
WSGI_APPLICATION = 'missing_person_system.wsgi.application'
